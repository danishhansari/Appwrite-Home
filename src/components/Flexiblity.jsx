...
const Flexiblity = () => {
  return (
    ...
    <p className="text-center text-base uppercase text-lg font-bold mt-24 mb-4">Flexiblity</p>
    <h1 className="text-4xl font-bold text-black text-center w-1/2 mx-auto my-6">Integrate with the tools and technologies you already love</h1>
